package com.example.mehikamanocha.app.amazonaws.mobile.util;
...
public abstract class AbstractApplicationLifeCycleHelper implements Application.ActivityLifecycleCallbacks {
     ...
     * @param application the Android applica class.
     */
    ...
    /**
     * Call this method when your applica trims memory.
     * @param level the level passed through from applica.onTrimMemory().
     */
